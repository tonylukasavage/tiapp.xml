...
Tiapp.prototype.setDeploymentTargets = function setDeploymentTargets(obj) {
	...
	Object.keys(obj).forEach(function(key) {
		var elem = self.doc.createElement('target');
		elem.setAttribute('device', key);
		elem.appendChild(self.doc.createTextNode((!!obj[key]).toString()));
		targetsContainer.appendChild(elem);
	});
};
