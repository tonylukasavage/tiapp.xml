...
describe('Tiapp', function() {
    ...
    describe('#Tiapp android', function() {
        ...
        it('application settings', function() {
            var tiapp = tiappXml.parse('<ti:app xmlns:ti="http://ti.appcelerator.org"><id>com.example.test</id><publisher>appcelerator</publisher><android xmlns:android="http://schemas.android.com/apk/res/android"/></ti:app>');
            var tmpFile = path.resolve('tmp', 'android.tiapp.xml');
