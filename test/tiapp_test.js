...
describe('Tiapp', function() {
    ...
    describe('#Tiapp android', function() {
        xit('should load android', function() {
        ...
        xit('should not load properties if no manifest, but will on addition', function() {
        ...
        xit('android permissions and uses-permissions', function() {
